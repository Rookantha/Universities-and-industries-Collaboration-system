...
public final class colPost_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String UniversityName = session.getAttribute("NameUniversity").toString();//"University of Colombo";
      ...
      out.write(" - Professional Events</title>\n");
      out.write("          <style>\n");
...
ResultSet resultSet = null;
      ...
      out.write("\n");
      out.write("<h2 align=\"center\" style=\"color: #009900\"> <font><strong> ");
      out.print(UniversityName);
      ...
      out.write("<td><b><font color=\"White\">University Name</font></b></td>\n");
...
String sql ="SELECT * FROM university_post_events WHERE universityName=? OR tagUniversity=? ORDER BY eventTime DESC";
...
while(resultSet.next()){
      ...
      out.write("\n");
      out.write("<td>");
      out.print(resultSet.getString("uniEventID") );
      out.write("</td>\n");
      out.write("<td>");
      out.print(resultSet.getString("universityName") );
      out.write("</td>\n");
      out.write("<td>");
...
e.printStackTrace();
      ...
      out.write("<br>\n");
      out.write("<form action=\"../commentServlet\" id=\"usrform\"  method=\"post\">\n");
      out.write("<label for=\"subject\">Your University</label> \n");
      out.write("<br>\n");
      out.write("<input type=\"text\" name=\"UniName\" readonly=\"true\" value=\"");
      out.print(UniversityName);
      out.write("\">  \n");
      out.write("<br>\n");
      out.write("<label for=\"subject\">Event ID</label> \n");
      out.write("<br>\n");
      out.write("<input type=\"text\" name=\"eventID\" align=\"left\" required >  \n");
      out.write("<br>\n");
      ...
      out.write("<br>\n");
      out.write("<textarea rows=\"4\" cols=\"50\" name=\"comment\" form=\"usrform\" required>\n");
      out.write("</textarea>\n");
      out.write("<br>\n");
...
connection = DriverManager.getConnection(connectionUrl+dbName ,userId, password);
statement=connection.createStatement();
String sqlone ="SELECT * FROM comment WHERE  univercity =?";
