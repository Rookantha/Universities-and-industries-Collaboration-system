...
public final class nsbmPost_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <title>NSBM - Professional Events</title>\n");
      out.write("<style>\n");
      out.write("\n");
...
ResultSet resultSet = null;
      ...
      out.write("\n");
      out.write("\n");
      out.write("<h2 align=\"center\" style=\"color: #009900\"> <font><strong>NSBM Green University (Western Province)</strong></font></h2>\n");
...
String sql ="SELECT * FROM university_post_events WHERE  universityName='NSBM' OR tagUniversity='NSBM' ORDER BY eventTime DESC";
...
e.printStackTrace();
      ...
      out.write("<br>\n");
      out.write("<form action=\"../nsbmCommentPost\" id=\"usrform\"  method=\"post\">\n");
...
connection = DriverManager.getConnection(connectionUrl+dbName ,userId, password);
statement=connection.createStatement();
String sqlone ="SELECT * FROM comment WHERE  univercity ='nsbm'";
