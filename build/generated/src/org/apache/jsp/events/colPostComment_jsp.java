...
public final class colPostComment_jsp extends org.apache.jasper.runtime.HttpJspBase
...
ResultSet resultSet = null;
      ...
      out.write("\n");
      out.write("<h2 align=\"center\" style=\"color: #009900\"> <font><strong>University of Colombo (Western Province) </strong></font></h2>\n");
...
String sql ="SELECT * FROM university_post_events WHERE universityName='University of Colombo' OR tagUniversity='University of Colombo' ORDER BY eventTime DESC";
...
e.printStackTrace();
      ...
      out.write("<br>\n");
      out.write("<form action=\"../Commenttest\" id=\"usrform\"  method=\"post\">\n");
...
connection = DriverManager.getConnection(connectionUrl+dbName ,userId, password);
statement=connection.createStatement();
String sqlone ="SELECT * FROM comment ";
