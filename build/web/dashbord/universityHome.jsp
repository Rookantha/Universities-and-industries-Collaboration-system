<%-- 
    Document   : universityHome
    Created on : Apr 4, 2019, 8:11:37 PM
    Author     : HP
--%>
...
<div id="mySidebar" class="sidebar">
  ...
  <a href="http://localhost:8080/plymouthapp/events/universityPostEventsJsp.jsp">Post Event</a>
  ...
  <a href="http://localhost:8080/plymouthapp/calender/colUniCalenderPost.jsp">Add Academic Calender</a>
...
<div id="main">
  <button class="openbtn" onclick="openNav()">☰ University </button>  
   <h3>Sharing With University and Industry Talks , Workshops , Events , Research , Academic Calendar Mach more ....</h3>
<div id = "select">      
   <h3>Check the Activities by Category...</h3>

<form class="form-inline" action="../univercityHomeServlet" method="post">
...
<br>
    ...
    <br>
    <h3 style="color: #009900"> All Industrial Events .......</h3>
...
<table align="center" cellpadding="8" cellspacing="10" border="0">
<tr bgcolor="#009900">
