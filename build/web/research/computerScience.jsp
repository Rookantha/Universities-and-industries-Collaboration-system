<%-- 
    ...
    Created on : Apr 17, 2019, 11:07:29 PM
    Author     : ISURU
--%>
...
<html>
    <head>
        ...
        <title>Research - Computer Science</title>
          <style>
...
<h2 align="center" style="color: #009900"> <font><strong>Research - Computer Science </strong></font></h2>
...
String sql ="SELECT * FROM post_reseach WHERE subject='Computer Science'";
...
connection = DriverManager.getConnection(connectionUrl+dbName ,userId, password);
statement=connection.createStatement();
String sqlone ="SELECT * FROM query WHERE subject ='Computer Science'";
