<%-- 
    Document   : NEResearch
    Created on : May 25, 2019, 8:08:31 AM
    Author     : ISURU
--%>
...
<html>
    <head>
       <head>
        ...
        <title>Research - Network Engineering</title>
          <style>
...
<h2 align="center" style="color: #009900"> <font><strong>Research - Network Engineering</strong></font></h2>
<h3> </h3>
...
String sql ="SELECT * FROM post_reseach WHERE subject='Network Engineering'";
...
<input type="hidden" name="Category" value="Network Engineering"/> 
...
connection = DriverManager.getConnection(connectionUrl+dbName ,userId, password);
statement=connection.createStatement();
String sqlone ="SELECT * FROM query WHERE subject ='Network Engineering'";
