<%-- 
    Document   : EResearch
    Created on : May 25, 2019, 8:14:22 AM
    Author     : ISURU
--%>
...
<h2 align="center" style="color: #009900"> <font><strong>Research - Engineering</strong></font></h2>
<h3> </h3>
...
String sql ="SELECT * FROM post_reseach WHERE subject='Engineering'";
...
connection = DriverManager.getConnection(connectionUrl+dbName ,userId, password);
statement=connection.createStatement();
String sqlone ="SELECT * FROM query WHERE subject ='Engineering'";
