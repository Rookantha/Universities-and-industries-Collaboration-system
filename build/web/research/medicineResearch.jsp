...
<h2 align="center" style="color: #009900"> <font><strong>Research - Medicine </strong></font></h2>
...
String sql ="SELECT * FROM post_reseach WHERE subject='Medicine'";
...
connection = DriverManager.getConnection(connectionUrl+dbName ,userId, password);
statement=connection.createStatement();
String sqlone ="SELECT * FROM query WHERE subject ='Medicine'";
