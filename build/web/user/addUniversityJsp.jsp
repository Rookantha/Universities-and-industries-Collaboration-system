<%-- 
    Document   : addUniversityJsp
    Created on : Apr 4, 2019, 4:24:33 PM
    Author     : HP
--%>
...
@media screen and (max-width: 600px) {
  .col-25, .col-75, input[type=submit] {
    ...
    <body>
        <h1 style="color: #4d88ff"> Create University Account </h1>
        <h3 style="color: #a6a6a6;"> Fill with University Details</h3> 

<div class="container">
    <form  method="post" action="../addUniversityServlet">
     <div class="row">
      <div class="col-25">
