<%-- 
    Document   : medicineResearch
    Created on : Apr 18, 2019, 6:21:49 PM
    Author     : ISURU
--%>
...
<html>
    <head>
       <head>
        ...
        <title>Research - Software Engineering</title>
          <style>
...
<h2 align="center" style="color: #009900"> <font><strong>Research - Software Engineering </strong></font></h2>
<h3> </h3>
...
String sql ="SELECT * FROM post_reseach WHERE subject='Software Engineering'";
...
connection = DriverManager.getConnection(connectionUrl+dbName ,userId, password);
statement=connection.createStatement();
String sqlone ="SELECT * FROM query WHERE subject ='Software Engineering'";
