<%-- 
    Document   : BMResearch
    Created on : May 25, 2019, 8:30:49 AM
    Author     : ISURU
--%>
...
<html>
    <head>
       <head>
        ...
        <title>Research - Business & Management</title>
          <style>
...
<h2 align="center" style="color: #009900"> <font><strong>Research - Business & Management</strong></font></h2>
<h3> </h3>
...
String sql ="SELECT * FROM post_reseach WHERE subject='Business & Management'";
...
<input type="hidden" name="Category" value="Business & Management"/> 
...
connection = DriverManager.getConnection(connectionUrl+dbName ,userId, password);
statement=connection.createStatement();
String sqlone ="SELECT * FROM query WHERE subject ='Business & Management'";
