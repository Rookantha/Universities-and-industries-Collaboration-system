<%-- 
    Document   : addIndustryJsp
    Created on : Apr 4, 2019, 4:10:42 PM
    Author     : HP
--%>
...
@media screen and (max-width: 600px) {
  .col-25, .col-75, input[type=submit] {
    ...
    <body>
        <h1 style="color: #4d88ff"> Create Industry Account </h1>
        <h3 style="color: #a6a6a6;"> Fill with Industry Details</h3> 

<div class="container">
  <form  method="post" action="../addIndustryServlet">
    <div class="row">
      <div class="col-25">
        <label for="eventVenue">Industry Full Name</label>
      </div>
      <div class="col-75">
        <input type="text" id="eventVenue" name="fullName" placeholder="Enter your Company Name.." required>
      </div>
    </div>
