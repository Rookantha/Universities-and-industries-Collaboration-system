<%-- 
    Document   : colPost
    Created on : Apr 6, 2019, 7:54:45 PM
    Author     : ISURU
--%>
...
<html>
    <head>
        ...
        %>
        <title><%=UniversityName%> - Professional Events</title>
          <style>
...
%>
<h2 align="center" style="color: #009900"> <font><strong> <%=UniversityName%> </strong></font></h2>
...
<td><%=resultSet.getString("uniEventID") %></td>
...
<br>
<form action="../commentServlet" id="usrform"  method="post">
<label for="subject">Selected University</label> 
<br>
<input type="text" name="UniName" readonly="true" value="<%=UniversityName%>">  
<br>
<label for="subject">Event ID</label> 
<br>
<input type="text" name="eventID" align="left" required >  
<br>
