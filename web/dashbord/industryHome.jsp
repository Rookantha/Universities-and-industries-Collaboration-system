<%-- 
    Document   : industryHome
    Created on : Apr 4, 2019, 7:07:08 PM
    Author     : Pubudu
--%>
...
<div id="mySidebar" class="sidebar">
    <%
        ...
        String UserType = session.getAttribute("UserType").toString();//get the logged usertype
    %>
  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">×</a>
  <a href="#" style="color:yellow"><%=UserName%></a>
  <a href="http://localhost:8080/plymouthapp/events/industryPostEvents.jsp">Post Events</a><!–– redirect to form to post new industry event ––>
  <a href="http://localhost:8080/plymouthapp/events/retrieveUniPostJsp.jsp">Professional Events</a><!–– redirect to all university events ––>
  <a href="http://localhost:8080/plymouthapp/events/retrieveIndustyPostJsp.jsp">Corporate Events</a><!–– redirect to all industry events ––>
  <a href="http://localhost:8080/plymouthapp/research/researchHome.jsp">Research</a><!–– redirect to all research findings page ––>
...
<div id="main">
  <button class="openbtn" onclick="openNav()">☰ Industry</button>  
  <h2>Sharing Industry Talks , Workshops , Events , Research Mach more .... </h2>
  
  <div id = "select">  
      
        <!–– search available functions sorted by category and university ––>
      
  <h3>Check the Activities by Category...</h3>

   
    
    <form class="form-inline" action="../industrryHomeServlet" method="post">
...
<button type="submit">Enter</button>
  ...
  <br>
    ...
    <br>
    <h3 style="color: #009900"> All University Events .......</h3>
    <br>
...
<tr bgcolor="#009900">
<td><b><font color="White">University Name</font></b></td>
